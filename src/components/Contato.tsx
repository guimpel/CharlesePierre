...
const Contato = () => {
  return (
    <section id="contato" className="py-24 md:py-32 bg-background border-t border-foreground/10">
      <div className="container mx-auto px-6 lg:px-12">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-foreground/60 font-body text-lg mb-12 max-w-xl mx-auto">
            Para shows, parcerias, imprensa ou outros assuntos, entre em contato com nossa equipe.
          </p>

          <div className="space-y-8">
            <div>
              <span className="text-sm font-body text-foreground/50 uppercase tracking-wider block mb-2">
                Assessoria / Shows
              </span>
              <a
                href="mailto:contato@charlespierre.com.br"
                className="inline-flex items-center gap-3 text-xl md:text-2xl font-display text-foreground hover:text-foreground/70 transition-colors tracking-wider"
              >
                <Mail size={24} />
          ...
          <div className="mt-16 pt-12 border-t border-foreground/10">
            <span className="text-sm font-body text-foreground/50 uppercase tracking-wider block mb-6">
              Redes Sociais
            </span>
            <div className="flex justify-center gap-8">
              ...
              <a href="#" className="text-foreground/50 hover:text-foreground transition-colors" aria-label="YouTube">
              ...
              <a href="#" className="text-foreground/50 hover:text-foreground transition-colors" aria-label="Facebook">
              ...
              <a href="#" className="text-foreground/50 hover:text-foreground transition-colors" aria-label="Spotify">
      ...
      {/* Footer */}
      <footer className="mt-24 pt-8 border-t border-foreground/10">
        <div className="container mx-auto px-6 lg:px-12">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-center md:text-left">
            <p className="text-foreground/40 text-sm font-body">
              Todos os direitos reservados © {new Date().getFullYear()} Charles & Pierre
            </p>
